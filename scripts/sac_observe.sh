...
for size in `seq 500 50 1250`; do
    ../sac2c/build_r/sac2c_p -noprelude -t mt_pth -mt_bind simple matmul.sac -o matmul -DP=$size -DITER=$ITER
...
# Without pinning
for size in `seq 500 50 1250`; do
    ../sac2c/build_r/sac2c_p -noprelude -t mt_pth matmul.sac -o matmul -DP=$size -DITER=$ITER
    for threads in `seq 1 16`; do
